...
- **Nouveau (2026-09-02) : tarifs au relevé, affichés et négociables sur le devis.** Le forfait mensuel fixe du contrat coût à la page a été supprimé : seuls les tarifs au 1 000 copies (N&B et couleur) comptent désormais. Dans Administration → Coût à la page, une liste affiche un tarif à saisir par référence — **les modèles RICOH qui ne diffèrent que par leurs options sont regroupés automatiquement** (ex. IM C3010 / C3010A / C3510 / C3510A ne forment qu'une seule ligne, 23 lignes au total au lieu de 35) : un seul tarif saisi s'applique à tous les modèles du groupe. Tous vides pour l'instant — à remplir avec vos vrais tarifs, puis cliquer sur "Enregistrer les tarifs au relevé". Ces tarifs par défaut se recopient automatiquement sur chaque nouveau devis dès qu'un copieur est sélectionné et que la case "Inclure le contrat coût à la page" est cochée ; ils apparaissent alors dans le devis (aperçu et PDF) et **restent modifiables devis par devis** si le client négocie — sans jamais changer le tarif catalogue.

## 4. Le catalogue : 35 modèles (26 copieurs RICOH + 9 imprimantes HP), système anti-confusion
